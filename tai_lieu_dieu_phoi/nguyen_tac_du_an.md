...
41. **Mọi kết quả nghiên cứu phải kèm báo cáo lợi nhuận danh mục theo thời gian.** Tối thiểu phải có equity curve, lợi nhuận tích lũy, CAGR, max drawdown và lợi nhuận theo năm; phải nêu rõ portfolio contract, benchmark, thời điểm rebalance/entry/exit và các loại chi phí đã hoặc chưa được tính. Nếu research phase chưa đủ cơ chế để mô phỏng danh mục thực thi đầy đủ thì vẫn phải xuất một `research profit proxy` có nhãn rõ ràng, đồng thời không được gọi proxy đó là lợi nhuận live/backtest hoàn chỉnh. Research bundle thiếu profit report được coi là incomplete.
