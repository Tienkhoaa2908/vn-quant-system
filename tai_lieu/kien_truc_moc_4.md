...
## Phu luc kien truc QD-0063: publication va external verification

Kien truc thuc thi da tao 17 san pham bat bien trong mot pipeline run. External verifier la lop doi soat ngoai repository product contract; sua verifier khong duoc phep sua product bytes hoac goi lai pipeline.
