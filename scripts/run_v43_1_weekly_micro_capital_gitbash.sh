...
BRANCH="agent/v43-1-weekly-micro-capital-cash-redeployment"
...
OUTPUT_DIR="$PWD/artifacts/weekly-micro-capital-v43-1-$RUN_ID"
OUTPUT_ZIP="$PWD/artifacts/UPLOAD_THIS_v43_1_WEEKLY_MICRO_CAPITAL-$RUN_ID.zip"
LOG="$PWD/artifacts/v43-1-weekly-micro-capital-$RUN_ID.log"
mkdir -p "$PWD/artifacts"

set +e
"$PYTHON_EXE" -m he_thong_dinh_luong.weekly_micro_capital_v43_1 \
...
if [[ "$RUN_EXIT" -ne 0 ]]; then
    FAILURE_DIR="$PWD/artifacts/v43-1-weekly-micro-capital-failure-$RUN_ID"
    FAILURE_ZIP="$PWD/artifacts/UPLOAD_THIS_v43_1_WEEKLY_MICRO_CAPITAL_FAILURE-$RUN_ID.zip"
    mkdir -p "$FAILURE_DIR"
...
echo "Chi upload file UPLOAD_THIS_v43_1_WEEKLY_MICRO_CAPITAL-*.zip."
